...
Para continuar, conviene aprovecharnos de [p5.js Web Editor](https://editor.p5js.org/profesorfaco/sketches/wBvBZ1V6n), teniendo a mano la [página de referencias de **p5.js**](https://p5js.org/es/reference/)
